...
provide your best guess for a possible answer in json form: {{ "answer": "...", "confidence": 0.... }} where the value of confidence is 1 if you are confident in the answer and 0 if not. If you cannot accurately determine the answer, return 0 for the confidence.
Example:
  search query results: ["a", "b", "c"]
...
Example:
  ...
  -> {{ "answer": "a", "confidence": 1 }}
)", std::make_wformat_args(titles, question));
